...
@section('title', 'Thêm tài khoản - ' . $resource->name)
            ...
            <div class="card">
                <div class="card-header bg-{{ $resource->color ?? 'primary' }} text-white">
                    <h5 class="card-title mb-0">
                        ...
                        @endif
                        Thêm tài khoản vào: {{ $resource->name }}
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.resources.accounts.store', $resource) }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('two_factor_secret') is-invalid @enderror"
                                        ...
                                        placeholder="Mã 2FA hoặc backup codes">{{ old('two_factor_secret') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('recovery_codes') is-invalid @enderror"
                                        ...
                                        placeholder="Các mã recovery khác">{{ old('recovery_codes') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                ...
                                placeholder="Ghi chú thêm về tài khoản này...">{{ old('notes') }}</textarea>
                            @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
