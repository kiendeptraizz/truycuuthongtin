                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('account_type') is-invalid @enderror" 
                                ...
                                <option value="Add mail" {{ old('account_type', $servicePackage->account_type) === 'Add mail' ? 'selected' : '' }}>
                                    Add mail
                                </option>
                                <option value="Team dùng chung" {{ old('account_type', $servicePackage->account_type) === 'Team dùng chung' ? 'selected' : '' }}>
                                    Team dùng chung
                                </option>
                            </select>
                            @error('account_type')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="cost_price"
                                   name="cost_price"
                                   value="{{ old('cost_price', $servicePackage->cost_price) }}"
                                   min="0"
                                   step="1000">
                            @error('cost_price')
                                <div class="invalid-feedback">{{ $message }}</div>
