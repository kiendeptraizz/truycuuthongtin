...
@section('title', 'Thống kê lợi nhuận chi tiết')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Dashboard phân tích lợi nhuận và hiệu suất kinh doanh</p>
        </div>
    ...
    <!-- Profit Stats Row (Thống kê lợi nhuận) -->
    <div class="row mb-4">
        <!-- Khách hàng mới -->
...
<script>
    ...
    function updateSummaryStats(summary) {
        ...
        <div class="metric-item">
            <div class="d-flex justify-content-between">
                ...
                <span class="text-success">${formatCurrency(summary.total_profit)}</span>
            </div>
        </div>
        <div class="metric-item">
            <div class="d-flex justify-content-between">
                <strong>Lợi nhuận TB/đơn:</strong>
                <span class="text-info">${formatCurrency(summary.total_orders > 0 ? summary.total_profit / summary.total_orders : 0)}</span>
            </div>
        </div>
        <div class="metric-item">
            <div class="d-flex justify-content-between">
    ...
    function updateServiceStats(services) {
        ...
        const totalProfit = services.reduce((sum, service) => sum + parseFloat(service.total_profit || 0), 0);

        let html = '';
        services.slice(0, 5).forEach((service, index) => {
            const percentage = totalProfit > 0 ?
                Math.round((parseFloat(service.total_profit || 0) / totalProfit) * 100) : 0;
            ...
            <div class="mb-3">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <small class="text-info">${percentage}% tổng lợi nhuận</small>
                </div>
            </div>
        `;
        });
    ...
    function updateGrowthComparison(growth) {
        ...
        <div class="col-md-4">
            <div class="text-center">
                <h5 class="text-success">Lợi nhuận</h5>
        ...
        <div class="col-md-4">
            <div class="text-center">
                <h5 class="text-primary">Đơn hàng</h5>
        ...
        <div class="col-md-4">
            <div class="text-center">
                <h5 class="text-info">Khách hàng</h5>
    ...
    function updateCustomerStats(customers) {
        ...
        html += '<thead><tr><th>Khách hàng</th><th>Tổng đơn</th><th>Lợi nhuận</th><th>GT TB/đơn</th></tr></thead>';
        html += '<tbody>';
        ...
        customers.forEach((customer, index) => {
            ...
            <tr>
                ...
                <td class="fw-bold text-success">${formatCurrency(customer.total_profit)}</td>
    ...
    function updateCustomerChart(customers) {
        ...
        customerChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: customers.slice(0, 6).map(c => c.total_profit),
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-6">
                                ...
                                <div class="h6 mb-0 text-success">${formatCurrency(category.total_profit)}</div>
                            </div>
                        </div>
                        <div class="mt-2">
                            <small class="text-muted">
    ...
    function updateCategoryChart(categories) {
        ...
        categoryChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: categories.map(c => c.total_profit),
