                ...
                <form method="POST" action="{{ route('admin.customers.store-service', $customer) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="hidden" name="warranty_days" id="warranty_days" value="{{ old('warranty_days') }}">
                            @error('warranty_days')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        {{-- Số tiền đơn hàng — format giống Số tiền lãi (data-currency, inputmode numeric) --}}
                        <div class="col-md-6 mb-3">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // =====================================================
        // WARRANTY CALCULATOR (giống duration nhưng cho bảo hành)
        // =====================================================
