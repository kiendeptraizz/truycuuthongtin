...
@section('title', 'Chỉnh sửa nhà cung cấp tiềm năng')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-2 text-gray-800 fw-bold">
                ...
                Chỉnh sửa nhà cung cấp tiềm năng
            </h1>
            <p class="mb-0 text-muted">{{ $potentialSupplier->supplier_code }} - {{ $potentialSupplier->supplier_name }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.potential-suppliers.show', $potentialSupplier) }}" class="btn btn-outline-info">
            ...
            <div class="card shadow">
                <div class="card-header bg-gradient-primary text-white py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-1 fw-bold text-white">Chỉnh sửa nhà cung cấp tiềm năng</h4>
                            <p class="mb-0 text-light opacity-75">{{ $potentialSupplier->supplier_code }}</p>
                        </div>
                    </div>
                </div>

                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.potential-suppliers.update', $potentialSupplier) }}" id="supplier-form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="supplier_code"
                                        value="{{ $potentialSupplier->supplier_code }}"
                                        readonly
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="supplier_name"
                                        name="supplier_name"
                                        value="{{ old('supplier_name', $potentialSupplier->supplier_name) }}"
                                        required>
                                    @error('supplier_name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="contact_person"
                                        name="contact_person"
                                        value="{{ old('contact_person', $potentialSupplier->contact_person) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="phone"
                                        name="phone"
                                        value="{{ old('phone', $potentialSupplier->phone) }}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email"
                                        ...
                                        id="email"
                                        name="email"
                                        value="{{ old('email', $potentialSupplier->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url"
                                        ...
                                        id="website"
                                        name="website"
                                        value="{{ old('website', $potentialSupplier->website) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('priority') is-invalid @enderror"
                                        ...
                                        <option value="low" {{ old('priority', $potentialSupplier->priority) == 'low' ? 'selected' : '' }}>Thấp</option>
                                        <option value="medium" {{ old('priority', $potentialSupplier->priority) == 'medium' ? 'selected' : '' }}>Trung bình</option>
                                        <option value="high" {{ old('priority', $potentialSupplier->priority) == 'high' ? 'selected' : '' }}>Cao</option>
                                    </select>
                                    @error('priority')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('expected_cooperation_date', $potentialSupplier->expected_cooperation_date?->format('Y-m-d')) }}">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror"
                                        id="address"
                                        name="address"
                                        rows="2">{{ old('address', $potentialSupplier->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('reason_potential') is-invalid @enderror"
                                        ...
                                        rows="2"
                                        placeholder="Ví dụ: Giá cả cạnh tranh, dịch vụ tốt, đánh giá cao...">{{ old('reason_potential', $potentialSupplier->reason_potential) }}</textarea>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                        id="notes"
                                        name="notes"
                                        rows="2">{{ old('notes', $potentialSupplier->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-section">
                            ...
                            <div id="services-container">
                                @forelse($potentialSupplier->services as $index => $service)
                                <div class="service-item" data-index="{{ $index }}">
                                    <button type="button" class="btn btn-outline-danger btn-sm btn-remove-service" style="display: {{ count($potentialSupplier->services) > 1 ? 'flex' : 'none' }};">
                                        <i class="fas fa-times"></i>
                                    </button>
                                    <h6 class="text-secondary">
                                        <i class="fas fa-laptop me-2"></i>Dịch vụ #<span class="service-number">{{ $index + 1 }}</span>
                                    </h6>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control"
                                                name="services[{{ $index }}][estimated_price]"
                                                value="{{ old("services.{$index}.estimated_price", $service->estimated_price) }}"
                                                min="0"
                                                step="1000"
                                                required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old("services.{$index}.unit", $service->unit) }}"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control"
                                                name="services[{{ $index }}][warranty_days]"
                                                value="{{ old("services.{$index}.warranty_days", $service->warranty_days) }}"
                                                min="0"
                                                max="3650">
                                        </div>
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control"
                                                ...
                                                rows="2">{{ old("services.{$index}.description", $service->description) }}</textarea>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label fw-semibold">
                                                Ghi chú
                                            ...
                                            <textarea class="form-control"
                                                ...
                                                rows="2">{{ old("services.{$index}.notes", $service->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @empty
                                <!-- No services, will add one via JavaScript -->
                                @endforelse
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.potential-suppliers.show', $potentialSupplier) }}" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let serviceIndex = {{ count($potentialSupplier->services) }};

    // If no services exist, add one
    if (serviceIndex === 0) {
        addService();
    }
    ...
    document.querySelectorAll('.btn-remove-service').forEach(btn => {
        btn.addEventListener('click', function() {
            removeService(btn.closest('.service-item'));
        });
    });
